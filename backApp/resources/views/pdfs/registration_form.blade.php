...
<head>
    ...
    <style>
        ...
        .logo {
            ...
            background: linear-gradient(135deg, #4F8FFF, #6C3CE1);
        }
        .info-cell { text-align: right; }
        .school-name { font-size: 16px; font-weight: bold; color: #4F8FFF; }
        .school-info { font-size: 9px; color: #6B7280; margin-top: 3px; }
        .title {
            font-size: 14px; font-weight: bold; text-align: center;
            margin: 10px 0; text-decoration: underline; color: #3A7BD5;
        }
        .section { margin-bottom: 12px; page-break-inside: avoid; }
        .section-title {
            font-size: 11px; font-weight: bold; background-color: #E8F0FE;
            padding: 5px 8px; margin-bottom: 8px;
            border-left: 3px solid #4F8FFF; color: #1A1A3E;
        }
        ...
        .student-photo {
            width: 110px; height: 130px; border-radius: 5px;
            object-fit: cover; border: 1px solid #E5E7EB;
        }
        .no-photo {
            width: 110px; height: 130px; border-radius: 5px;
            background-color: #F5F7FA; display: flex; align-items: center;
            justify-content: center; color: #9CA3AF; font-size: 11px;
        ...
        .signatures-table {
            width: 100%; margin-top: 25px; margin-bottom: 15px; border-collapse: collapse;
        }
        .signatures-table td {
            width: 50%; text-align: center; vertical-align: bottom; padding: 0 20px;
        }
        .signature-line {
            border-top: 1px solid #1A1A3E; margin-top: 35px;
            padding-top: 8px; font-size: 9px;
        }
        .signature-date { font-size: 8px; color: #6B7280; margin-top: 5px; }

        .footer-info {
            width: 100%; margin-top: 15px; border-top: 1px solid #E5E7EB; padding-top: 10px;
        }
    ...
    <table class="header-table">
        <tr>
            <td style="width: 70%; vertical-align: middle; text-align: left;">
                <div class="school-name" style="font-size: 18px;">CAB Informatique</div>
                <div class="school-info" style="font-size: 10px; margin-top: 5px;">
                    {{ $campus->address ?? 'Siège Principal' }}<br>
                    Tél: {{ $campus->phone ?? '-' }} | Email: {{ $campus->email ?? '-' }}
                </div>
            </td>
            <td style="width: 30%; vertical-align: middle; text-align: right;">
                <!-- ✅ LOGO À DROITE : Utilise public_path pour que DomPDF le trouve -->
                <img src="{{ public_path('logo.jpg') }}" style="width: 80px; height: 80px; object-fit: contain; border-radius: 50%; border: 2px solid #4F8FFF;" alt="Logo CAB">
            </td>
        </tr>
    </table>
            ...
            <tr>
                <td style="width: 65%; vertical-align: top;">
                    <table class="info-table">
                        ...
                        <tr><td class="info-label">Lieu de résidence :</td><td class="info-value">{{ $student->residence ?? '-' }}</td></tr> <!-- ✅ MODIFIÉ -->
                        ...
                        <tr><td class="info-label">Diplôme le plus élevé :</td><td class="info-value">{{ $student->highest_diploma ?? '-' }}</td></tr>
                        <tr><td class="info-label">Année d'obtention :</td><td class="info-value">{{ $student->diploma_year ?? '-' }}</td></tr>
                                                <tr>
                            <td class="info-label">Langues parlées :</td>
                            <td class="info-value">
                                @php
                                    // ✅ Décodage sécurisé : gère à la fois le tableau PHP et la chaîne JSON brute
        ...
        <tr>
            ...
            <td class="right-col">
                ...
                <table class="info-table">
                    ...
                    <tr><td class="info-label">Statut :</td><td class="info-value" style="text-transform: uppercase;">{{ $registration->status ?? 'Confirmé' }}</td></tr>
                </table>
            </td>
        </tr>
    </table>

    <!-- Frais de scolarité (✅ MONTANTS CORRIGÉS AVEC PROMO) -->
    <div class="section">
